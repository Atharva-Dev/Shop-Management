    ...
    void admin()
    {
        ...
        void init_list()
        {
            ...
            while(1)
            {
                ...
                {
                    if(x<L.size()) item_info(L[x],Sp[x],St[x]);
                }
                else
                {
                    if(ch==56)
        ...
        void item_info(string s, int sp, int st)
        {
            char c;
            init();
            cout<<"Item name: "<<s<<endl<<endl;
            cout<<"Selling Price: "<<sp<<endl<<endl;
            cout<<"Available Stock: "<<st<<endl<<endl;

            cout<<"Do you want to make changes about "<<s<<" ? [y/n]  ";
            cin>>c;
            c == 'y' || c == 'Y' ? updateitem(s) : init() ;
        }
